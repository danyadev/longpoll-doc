...
4. [Описание событий](#описание-событий)
   ...
   - [Событие 91. Запрет писать в чат участнику](#событие-91-запрет-писать-в-чат-участнику)
...
### Событие 91. Запрет писать в чат участнику
...
Значения `actionType`:
  * `1` - участнику `memberId` запрещено писать в чат `peerId` на `seconds` секунд — до `untilTime`
  * `2` - участнику `memberId` запрещено писать в чат `peerId` навсегда
  * `3` - участнику `memberId` разрешено писать в чат `peerId`
...
* Всем участникам, кроме администраторов, запрещено писать в чат: `137438953472` (`1` << `37`)

__Обратите внимание!__ LongPoll не возвращает время, в течении которого запрещено писать в чат. После получения флага вам придётся запрашивать из API беседу и в нём узнать время запрета.

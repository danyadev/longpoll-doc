...
* Кто может приглашать участников в беседу
  * Только создатель: `2097152`
  * Создатель и администраторы: `1`
  * Все пользователи: `0`
* Кто может редактировать информацию беседы
  * Только создатель: `4194304`
  * Создатель и администраторы: `8`
  * Все пользователи: `0`
* Кто может менять закреплённое сообщение
  * Только создатель: `8388608`
  * Создатель и администраторы: `4`
  * Все пользователи: `0`
* Кто может отправлять массовые упоминания
  * Только создатель: `1048576`
  * Создатель и администраторы: `524288`
  * Все пользователи: `0`
* Кто может видеть ссылку на беседу
  * Только создатель: `0`
  * Создатель и администраторы: `16777216`
  * Все пользователи: `33554432`
* Кто может начинать групповые звонки
  * Только создатель: `134217728`
  * Создатель и администраторы: `67108864`
  * Все пользователи: `0`
* Кто может назначать администраторов
  * Только создатель: `0`
  * Создатель и администраторы: `16`

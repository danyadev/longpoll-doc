...
Рекомендую добавлять в маску все флаги, потому что обычно требуется вся приходящая информация.
К тому же, документация написана в расчете на то, что лонгпул будет присылать все данные.

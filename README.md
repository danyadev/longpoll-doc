...
_тут будет картинка, визуально объясняющее событие_
```
//                          ↓ count
...
Первый элемент, возможно, кол-во `id`-ов участников, которые идут далее. Он всегда равен `1`, если `id` участников доступны, или `0`, если нет. После `id` учаснтиков идёт `id` реакции, и он расположен в самом конце массива.

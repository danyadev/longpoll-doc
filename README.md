...
5. Прослушивание голосового сообщения (`audio_listened`)
...
Метод вернет `1` при первом прослушивании голосовое сообщения, а `0` при последующих или при попытке прослушать свое сообщение.

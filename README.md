...
Первый элемент, _возможно_, кол-во `id`-ов участников, которые идут далее. Он всегда равен `1`, если `id` участников доступны, или `0`, если нет. После `id` участников идёт `id` реакции, и он расположен в самом конце массива.

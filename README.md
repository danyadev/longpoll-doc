...
- `type` - Тип действия:
   - `0` - Из этой беседы был создан фантомный чат
      - `extra` = `0`
   ...
   - `4` - Изменение прав в беседе  
      Поле `extra` является маской, которая содержит информацию о настроенных правах.
      Описание всех прав доступа находится [здесь](#права-доступа-в-беседах).
...
* Кто может приглашать участников в беседу
  * Только создатель: `1 << 21` (`2097152`)
  * Создатель и администраторы: `1 << 0` (`1`)
  * Все участники: `0`
* Кто может редактировать информацию беседы
  * Только создатель: `1 << 22` (`4194304`)
  * Создатель и администраторы: `1 << 3` (`8`)
  * Все участники: `0`
* Кто может менять закреплённое сообщение
  * Только создатель: `1 << 23` (`8388608`)
  * Создатель и администраторы: `1 << 2` (`4`)
  * Все участники: `0`
* Кто может отправлять массовые упоминания
  * Только создатель: `1 << 29` (`1048576`)
  * Создатель и администраторы: `1 << 19` (`524288`)
  * Все участники: `0`
* Кто может видеть ссылку на беседу
  * Только создатель: `0`
  * Создатель и администраторы: `1 << 24` (`16777216`)
  * Все участники: `1 << 25` (`33554432`)
* Кто может начинать групповые звонки
  * Только создатель: `1 << 27` (`134217728`)
  * Создатель и администраторы: `1 << 26` (`67108864`)
  * Все участники: `0`
* Кто может назначать администраторов
  * Только создатель: `0`
  * Создатель и администраторы: `1 << 4` (`16`)

Дополнительные флаги:
* Имеется фантомная копия чата: `1 << 16` (`65536`)
* Является фантомным чатом: `1 << 15` (`32768`)

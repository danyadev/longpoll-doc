...
__Обратите внимание!__ Если реакций в сообщении много, то `id` участников не будут приходить, только их количество. А `...userIds[]` будет содержать всего один элемент: `0`

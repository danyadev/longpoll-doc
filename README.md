...
`1 << 8` (`256`) - Активен запрос на вступление в беседу

`1 << 9` (`512`) - Отклонен запрос на вступление в беседу

`1 << 10` (`1024`) - То же, что и `1 << 14` (`16384`) __`deprecated`__
...
Событие приходит только в методе [`messages.getLongPollHistory`](https://vk.com/dev/messages.getLongPollHistory)
